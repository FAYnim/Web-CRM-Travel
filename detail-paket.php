...
<body>
      ...
      <div class="detail__layout">
        ...
        <aside class="detail__sidebar">
          <div class="price-box">
            ...
            <a href="<?php echo htmlspecialchars($footerKontak['whatsapp'] !== '' ? 'https://wa.me/' . $footerKontak['whatsapp'] . '?text=' . rawurlencode('Halo ' . $footerKontak['nama_perusahaan'] . ', saya tertarik dengan paket ' . $p['nama_paket'] . ' (' . format_harga($p['harga']) . '/orang). Mohon info lebih lanjut mengenai ketersediaan jadwal dan detail pembayaran. Terima kasih!') : 'kontak.php'); ?>" class="btn btn--primary btn--lg btn--full" target="_blank" rel="noopener noreferrer">
  ...
  <section class="cta-banner reveal">
    <div class="cta-banner__content">
      ...
      <p class="cta-banner__text">Jangan tunda lagi! Hubungi kami sekarang untuk mendapatkan penawaran terbaik dan wujudkan liburan impian Anda bersama <?php echo htmlspecialchars($footerKontak['nama_perusahaan']); ?>.</p>
    ...
    <div class="container">
      <div class="footer__grid">
        ...
        <div class="footer__brand">
          <div class="footer__brand-name"><?php echo htmlspecialchars($footerKontak['nama_perusahaan']); ?></div>
          ...
          <?php if (!empty($footerKontak['social_links'])): ?>
            <div class="footer__social">
              <?php foreach ($footerKontak['social_links'] as $platform => $url): ?>
                <a href="<?php echo htmlspecialchars($url); ?>" class="footer__social-link" aria-label="<?php echo htmlspecialchars(ucfirst($platform) . ' ' . $footerKontak['nama_perusahaan']); ?>" target="_blank" rel="noopener noreferrer">
