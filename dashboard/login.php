            ...
            <div class="mockup-wrapper">
                <div class="dashboard-canvas">
                    ...
                    <div class="mock-card card-sales">
                        <div class="card-lbl">Total Pemesanan</div>
                        <div class="card-val">1.289</div>
                        <div class="card-change">+ 8% bulan ini</div>
                    </div>

                    <!-- 3. Floating Card: Chat Performance -->
                    <div class="mock-card card-chat">
                        <div class="card-lbl">Respons Admin</div>
                        <div class="card-val">00:01:12</div>
                    ...
                    <div class="mock-card card-profit">
                        <div class="card-lbl">Pendapatan</div>
                        <div class="card-val">Rp 682 jt</div>
                    ...
                    <div class="mock-card card-categories">
                        <div class="card-title">Kategori Favorit</div>
                        <div class="chart-radial-wrapper">
                            ...
                            <div class="radial-center-text">
                                ...
                                <div class="radial-center-lbl">Paket</div>
                            </div>
                        </div>
                        <div class="categories-list">
                            <div class="category-row">
                                ...
                                <span class="category-val">3.640 Paket</span>
                            </div>
                            <div class="category-row">
                                <div class="category-name-group">
                                ...
                                <span class="category-val">750 Paket</span>
                            </div>
                            <div class="category-row">
                                <div class="category-name-group">
                                ...
                                <span class="category-val">1.849 Paket</span>
                            </div>
                        </div>
                    </div>
