        ...
        <div class="page-content">
            ...
            <div class="dashboard-card">
                ...
                <div class="card-body p-0">
                    <p class="text-muted px-3 pt-3 mb-3">Berikut adalah data klien korporasi yang sudah terdaftar</p>
                    <div class="table-responsive">
                        <table class="table table-dashboard">
                            ...
                            <tbody>
                                <?php
                                // Query untuk mengambil data klien korporasi
                                $data = mysqli_query($koneksi, "SELECT * FROM klien_korporasi ORDER BY id DESC");
                                $no = 0;
                                ...
                                <tr>
                                    ...
                                    <td style="max-width: 250px;">
                                        <strong><?php echo htmlspecialchars($baris['nama_perusahaan']); ?></strong><br>
                                        <small class="text-muted"><?php echo htmlspecialchars($baris['alamat']); ?></small>
                                    </td>
                                    <td>
                                        <?php echo htmlspecialchars($baris['nama_pic']); ?><br>
                                        <small class="text-muted"><?php echo htmlspecialchars($baris['jabatan_pic']); ?></small>
                                    </td>
                                    <td>
