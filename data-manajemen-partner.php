        ...
        <div class="page-content">
            ...
            <div class="dashboard-card">
                ...
                <div class="card-body p-0">
                    <p class="text-muted px-3 pt-3 mb-3">Berikut adalah data partner maskapai yang sudah terdaftar</p>
                        ...
                        <table class="table table-dashboard">
                            <thead>
                                <tr>
                                    ...
                                    <th>Kode IATA</th>
                                    <th>Negara Asal</th>
                                    <th style="width: 200px; max-width: 200px;">Deskripsi</th>
                                    <th>Status</th>
                            ...
                            <tbody>
                                <?php
                                // Query untuk mengambil data partner maskapai
                                $data = mysqli_query($koneksi, "SELECT * FROM partner_maskapai ORDER BY id DESC");
                                $no = 0;
                                ...
                                <tr>
                                    <td><?php echo $no; ?></td>
                                    <td><?php echo htmlspecialchars($baris['nama_maskapai']); ?></td>
                                    <td><span class="badge bg-info text-dark"><?php echo htmlspecialchars($baris['kode_maskapai']); ?></span></td>
                                    <td><?php echo htmlspecialchars($baris['negara_asal']); ?></td>
                                    <td style="width: 200px; max-width: 200px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"><?php echo htmlspecialchars(substr($baris['deskripsi'], 0, 40)) . (strlen($baris['deskripsi']) > 40 ? '...' : ''); ?></td>
                                    <td>
